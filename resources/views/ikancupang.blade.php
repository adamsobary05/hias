...
<body>
    ...
    <section class="single-post-area">
        <!-- Single Post Title -->
        <div class="single-post-title bg-img background-overlay" style="background-image: url(img/bg-img/cupang.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="single-post-title-content">
                            ...
                            <h2 class="font-pt">Ikan Cupang</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8">
                        <div class="single-post-text">
                          <p><h2>Harga Ikan Cupang Dan Jenisnyah</h2></p>
                         <p>Harga Ikan Cupang Giant	Rp 20.000 - Rp 200.000</p>
                         <p>Harga Ikan Cupang Halfmoon	Rp 40.000 - Rp 500.000</p>
                         <p>Harga Ikan Cupang Fancy	Rp 100.000 - Rp 2.500.000</p>
                         <p>Harga Ikan Cupang Crown Tail / Serit	Rp 15.000 - Rp 300.000</p>
                    </div>
    </section>
