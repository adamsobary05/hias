...
<html lang="en">
<head>
	<title>Jual Online Makanan Ikan Hias</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<div class="flex-c-m size22 bg0 s-text21 pos-relative">
		Ikan Hias Dijl.Muara Macam-macam Jenis Ikan Hias Dan Harga Yang Terjangkau
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(assets/frontend/images/kan.jpg);">
	...
	<section class="newproduct bgwhite p-t-45 p-b-105">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					@foreach ($makanan as $lihat)
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="/assets/img/makanan/{{ $lihat->foto }}" alt="" >
							...
							<div class="block2-txt p-t-20">
								...
								<b>{{$lihat->nama_makanan}}</b>
								</a>

								<span class="block2-price m-text6 p-r-5">
									<b>{{$lihat->harga_makanan}}</b>
									<br>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="{{asset('assets/frontend/images/judul1.jpg') }}" alt="IMG-BLOG">
						</a>
