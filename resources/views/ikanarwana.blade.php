...
<body>
    ...
    <section class="single-post-area">
        <!-- Single Post Title -->
        <div class="single-post-title bg-img background-overlay" style="background-image: url(img/bg-img/arana.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="single-post-title-content">
                            ...
                            <h2 class="font-pt">Ikan Arwana</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8">
                        <div class="single-post-text">
                          <p><h2>Arwana</h2></p>
                          <p>Ikan Arwana Papua atau yang dikenal pula dengan sebutan Arwana Jardini hidup di perairan Papua hingga Australia. Jenis ikan Arwana yang bisa tumbuh hingga sepanjang 90 cm dan berat sampai 17 kg ini memiliki warna kuning keemasan namun tidak terlalu mencolok.</p>
                          <p>Ciri-ciri utama dari fisik ikan Arwana Papua adalah badannya yang berwarna dasar hitam kecokelat-cokelatan dengan bintik-bintik kuning keemasan, bahkan hingga di bagian kepala hingga sirip dan ekornya. Harga ikan jenis ini sekitar Rp4 jutaan.</p>
                    </div>
    </section>
