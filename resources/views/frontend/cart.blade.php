...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(assets/frontend/images/koi2.jpg);">
				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						<tr class="table-head">
							...
							<th class="column-2">Nama Ikan</th>
							<th class="column-3">Harga Ikan</th>
							...
							<tr class="table-row">
							<td class="column-1">
							<form action="{{url('/updatekeranjang')}}">
							{{ csrf_field() }}
							...
							<td class="column-2">{{ $data['nama_ikan']}}</td>
							<td class="column-3">
									&nbsp;&nbsp;&nbsp;
										<div class="product_price text-lg-center product_text"><span></span>Rp {{$data['harga_ikan']}}</div>
										<div class="product_quantity_container">
											{{-- <span class="product_text product_num">{{$data['qty']}}</span> --}}
												<div class="qty_sub qty_button trans_200 text-center"></div>
										</div>
							</td>
							<td class="column-4">
